...
from db.db import users_insert
...
from db.db import users_select
...
#     users_insert(login=create_user.login, psw=create_user.psw)
...
# # извлекая из него следующие параметры:
# # 'username': username,
# # 'id': user_id,
# # 'is_admin': is_admin,
